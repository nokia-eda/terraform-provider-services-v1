...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-services/internal/resource_bridge_domain"
	"github.com/nokia/eda/apps/terraform-provider-services/internal/tfutils"
)

const (
	create_rs_bridgeDomain = "/apps/services.eda.nokia.com/v1/namespaces/{namespace}/bridgedomains"
	read_rs_bridgeDomain   = "/apps/services.eda.nokia.com/v1/namespaces/{namespace}/bridgedomains/{name}"
	update_rs_bridgeDomain = "/apps/services.eda.nokia.com/v1/namespaces/{namespace}/bridgedomains/{name}"
	delete_rs_bridgeDomain = "/apps/services.eda.nokia.com/v1/namespaces/{namespace}/bridgedomains/{name}"
)

var (
	_ resource.Resource                = (*bridgeDomainResource)(nil)
	_ resource.ResourceWithConfigure   = (*bridgeDomainResource)(nil)
	_ resource.ResourceWithImportState = (*bridgeDomainResource)(nil)
)
...
func (r *bridgeDomainResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_bridge_domain.BridgeDomainResourceSchema(ctx)
}

func (r *bridgeDomainResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_bridge_domain.BridgeDomainModel
	...
	err = r.client.Create(ctx, create_rs_bridgeDomain, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_bridgeDomain, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_bridgeDomain,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *bridgeDomainResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_bridgeDomain, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *bridgeDomainResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_bridgeDomain, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *bridgeDomainResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
