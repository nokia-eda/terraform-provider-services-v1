...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-services/internal/eda/utils"
...
func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &servicesProvider{version: ver}
	}
}
...
func (p *servicesProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *servicesProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "services-v1"
	resp.Version = p.version
}

func (p *servicesProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewBridgeDomainDataSource,
		NewBridgeDomainListDataSource,
		NewBridgeInterfaceDataSource,
		NewBridgeInterfaceListDataSource,
		NewDhcpRelayDataSource,
		NewDhcpRelayListDataSource,
		NewEdgePingDataSource,
		NewEdgePingListDataSource,
		NewIrbInterfaceDataSource,
		NewIrbInterfaceListDataSource,
		NewResourceListDataSource,
		NewRoutedInterfaceDataSource,
		NewRoutedInterfaceListDataSource,
		NewRouterDataSource,
		NewRouterListDataSource,
		NewVirtualNetworkDataSource,
		NewVirtualNetworkListDataSource,
		NewVlanDataSource,
		NewVlanListDataSource,
		NewWorkflowGetInputsRespElemDataSource,
	}
}

func (p *servicesProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewBridgeDomainResource,
		NewBridgeInterfaceResource,
		NewDhcpRelayResource,
		NewIrbInterfaceResource,
		NewRoutedInterfaceResource,
		NewRouterResource,
