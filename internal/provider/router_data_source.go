...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-services/internal/datasource_router"
...
const read_ds_router = "/apps/services.eda.nokia.com/v1/namespaces/{namespace}/routers/{name}"
...
func (d *routerDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_router"
}

func (d *routerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_router.RouterDataSourceSchema(ctx)
}

func (d *routerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_router.RouterModel
	...
	err = d.client.GetByQuery(ctx, read_ds_router, map[string]string{
...
func (r *routerDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
