...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-services/internal/resource_vlan"
	"github.com/nokia/eda/apps/terraform-provider-services/internal/tfutils"
)

const (
	create_rs_vlan = "/apps/services.eda.nokia.com/v1/namespaces/{namespace}/vlans"
	read_rs_vlan   = "/apps/services.eda.nokia.com/v1/namespaces/{namespace}/vlans/{name}"
	update_rs_vlan = "/apps/services.eda.nokia.com/v1/namespaces/{namespace}/vlans/{name}"
	delete_rs_vlan = "/apps/services.eda.nokia.com/v1/namespaces/{namespace}/vlans/{name}"
)
...
func (r *vlanResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_vlan, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_vlan, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *vlanResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_vlan, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *vlanResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_vlan, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
