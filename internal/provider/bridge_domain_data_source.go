...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-services/internal/datasource_bridge_domain"
...
const read_ds_bridgeDomain = "/apps/services.eda.nokia.com/v1/namespaces/{namespace}/bridgedomains/{name}"

var (
	_ datasource.DataSource              = (*bridgeDomainDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*bridgeDomainDataSource)(nil)
)
...
func (d *bridgeDomainDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *bridgeDomainDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_bridge_domain.BridgeDomainDataSourceSchema(ctx)
}

func (d *bridgeDomainDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_bridge_domain.BridgeDomainModel
	...
	err = d.client.GetByQuery(ctx, read_ds_bridgeDomain, map[string]string{
...
func (r *bridgeDomainDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
