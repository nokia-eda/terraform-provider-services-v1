...
func EdgePingResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^EdgePing$"), ""),
				},
				Default: stringdefault.StaticString("EdgePing"),
			},
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"ping_type": schema.StringAttribute{
						Required: true,
						Validators: []validator.String{
				...
				MarkdownDescription: "EdgePingSpec defines the desired state of EdgePing",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "EdgePingStatus defines the observed state of EdgePing",
			},
		},
	}
}

type EdgePingModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	pingTypeAttribute, ok := attributes["ping_type"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`ping_type is missing from object`)

		return nil, diags
	}

	pingTypeVal, ok := pingTypeAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`ping_type expected to be basetypes.StringValue, was: %T`, pingTypeAttribute))
	}

	virtualNetworkAttribute, ok := attributes["virtual_network"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`virtual_network is missing from object`)

		return nil, diags
	}

	virtualNetworkVal, ok := virtualNetworkAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`virtual_network expected to be basetypes.StringValue, was: %T`, virtualNetworkAttribute))
	}
	...
	return SpecValue{
		...
		PingType:          pingTypeVal,
		VirtualNetwork:    virtualNetworkVal,
		VlanId:            vlanIdVal,
		state:             attr.ValueStateKnown,
	}, diags
}
...
type SpecValue struct {
	...
	PingType          basetypes.StringValue `tfsdk:"ping_type"`
	VirtualNetwork    basetypes.StringValue `tfsdk:"virtual_network"`
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["ping_type"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["virtual_network"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.PingType.ToTerraformValue(ctx)
		...
		val, err = v.VirtualNetwork.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["virtual_network"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		...
		"ping_type":          basetypes.StringType{},
		"virtual_network":    basetypes.StringType{},
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"ping_type":          v.PingType,
			"virtual_network":    v.VirtualNetwork,
			"vlan_id":            v.VlanId,
		})
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.PingType.Equal(other.PingType) {
		return false
	}

	if !v.VirtualNetwork.Equal(other.VirtualNetwork) {
		return false
	}
