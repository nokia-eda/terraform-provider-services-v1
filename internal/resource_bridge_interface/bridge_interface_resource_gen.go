...
package resource_bridge_interface
...
func BridgeInterfaceResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^BridgeInterface$"), ""),
				},
				Default: stringdefault.StaticString("BridgeInterface"),
			},
			...
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"uplinks": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Uplinks status within the BridgeInterface.",
					},
				},
