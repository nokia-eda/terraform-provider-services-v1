---
page_title: "services-v1 Provider"
---

# services-v1 Provider

This provider is used to interact with the resources provided by the **services-v1** application of the [Nokia EDA](https://docs.eda.dev) platform.
