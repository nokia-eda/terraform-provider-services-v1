...
- `uplinks` (Attributes List) Uplinks status within the BridgeInterface. (see [below for nested schema](#nestedatt--items--status--uplinks))
...
<a id="nestedatt--items--status--uplinks"></a>
### Nested Schema for `items.status.uplinks`
